...
// WikedInitImage: define built-in image URLs
	window.WikedInitImage = function() {
		WikEdInitImage(wikEdImage, {
			...
			'bold':                'WikEd_bold.png',
			'browser':             'WikEd_disabled.png',
			'bulletList':          'WikEd_bullet_list.png',
			'case':                'WikEd_case.png',
			'caseSensitive':       'WikEd_case_sensitive.png',
			'clearHistory':        'WikEd_clear_history.png',
			'clearSummary':        'WikEd_clear_summary.png',
			'close':               'WikEd_close.png',
			'closeToolbar':        'WikEd_close_toolbar.png',
			'ctrl':                'WikEd_ctrl.png',
			'definitionList':      'WikEd_definition_list.png',
			'diff':                'WikEd_diff.png',
			'disabled':            'WikEd_disabled.png',
			'dummy':               'WikEd_dummy.png',
			'error':               'WikEd_error.png',
			'findAhead':           'WikEd_find_ahead.png',
			'findAll':             'WikEd_find_all.png',
			'findNext':            'WikEd_find_next.png',
			'findPrev':            'WikEd_find_prev.png',
			'fixAll':              'WikEd_fix_all.png',
			'fixBasic':            'WikEd_fix_basic.png',
			'fixCaps':             'WikEd_fix_caps.png',
			'fixUnicode':          'WikEd_fix_unicode.png',
			'fixChem':             'WikEd_fix_chem.png',
			'fixDash':             'WikEd_fix_dash.png',
			'fixHtml':             'WikEd_fix_html.png',
			'fixMath':             'WikEd_fix_math.png',
			'fixPunct':            'WikEd_fix_punct.png',
			'fixRegExTypo':        'WikEd_fix_reg-ex-typo.png',
			'fixUnits':            'WikEd_fix_units.png',
			'textZoom':            'WikEd_font_size.png',
			'fullScreen':          'WikEd_fullscreen.png',
			'getFind':             'WikEd_get_selection.png',
			'grip':                'WikEd_grip.png',
			'heading':             'WikEd_heading.png',
			'highlightSyntax':     'WikEd_syntax.png',
			'image':               'WikEd_image.png',
			'indentList':          'WikEd_indent_list.png',
			'italic':              'WikEd_italic.png',
			'jumpNext':            'WikEd_jump_next.png',
			'logo':                'WikEd_logo.png',
			'nowiki':              'WikEd_nowiki.png',
			'numberList':          'WikEd_number_list.png',
			'jumpPrev':            'WikEd_jump_prev.png',
			'preview':             'WikEd_preview.png',
			'redirect':            'WikEd_redirect.png',
			'redo':                'WikEd_redo.png',
			'ref':                 'WikEd_ref.png',
			'refHide':             'WikEd_ref_hide.png',
			'references':          'WikEd_references.png',
			'redoAll':             'WikEd_redo_all.png',
			'regExp':              'WikEd_regexp.png',
			'replaceAll':          'WikEd_replace_all.png',
			'replaceNext':         'WikEd_replace_next.png',
			'replacePrev':         'WikEd_replace_prev.png',
			'scrollToEdit':        'WikEd_align_top.png',
			...
			'undo':                'WikEd_undo.png',
			'undoAll':             'WikEd_undo_all.png',
			'unknown':             'WikEd_unknown.png',
			'useWikEd':            'WikEd_logo.png',
			'using':               'WikEd_using.png',
			'webLink':             'WikEd_weblink.png',
			'wikEdDiff':           'WikEdDiff.png',
			'wikify':              'WikEd_wikify.png',
